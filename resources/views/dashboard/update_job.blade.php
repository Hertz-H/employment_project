            ...
            <div class="form-container  ">
                ...
                <form class="row g-3 " action="{{ route('updatejob')}}" method="post" enctype="multipart/form-data">
                  @csrf                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" id="Title"name="title" required value="{{$data['job']['title']}}">
                      <input  style="display:none;" type="text" class="form-control" id="Title"name="id" required  value="{{$data['job']['id']}}">
                    ...
                    <div class="col-6">
                        ...
                        <input type="date" class="form-control" id="inputFrom" placeholder="" name="from"required value="{{$data['job']['start_date']}}">
                        @error('from')
                        <span style="color:red;font-size:12px"> {{ $message }} </span> 
                    ...
                    <div class="col-6">
                      ...
                      <input type="date" class="form-control" id="inputTo" placeholder="" name="to"required value="{{$data['job']['end_date']}}">
                    </div>
                    @error('to')
                      <span style="color:red;font-size:12px"> {{ $message }} </span> 
