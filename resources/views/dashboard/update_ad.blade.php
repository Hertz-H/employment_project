...
@section('content')
            ...
            <div class="form-container  ">
                <h3 > Adds</h3>
                <form class="row g-3  " action="{{ route('updateAd')}}" method="post" enctype="multipart/form-data">
                  @csrf
                    <div class="col-md-6">
                      <label for="Title" class="form-label" >Company</label>
                      <input type="text" class="form-control" id="Title"name="name" required value="{{ $data['company']}}">
                    ...
                    <div class="col-md-6">
                      <label for="Company" class="form-label">Ad Image</label>
