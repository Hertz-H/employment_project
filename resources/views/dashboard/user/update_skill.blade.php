...
@section('content')
            ...
            <div class="form-container  ">
                <h3 > Skill</h3>
                <form class="row g-3  " action="{{ route('updateSkill')}}" method="post" enctype="multipart/form-data">
                  @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" id="Company" name="degree" required value="{{$data['degree']}}">
                      @error('degree')
                      <span style="color:red;font-size:12px"> {{ $message }} </span> 
